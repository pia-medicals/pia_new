...
*/
              ...
              if($rid == 0){
               ...
               ///  $acccustomer = $cus['cid'];
                        ...
                        if($customer == 'RADNET')
                      {
                          ...
                          if ($institution == 'Rolling Oaks Radiology')
                              {
                               $acccustomer = 175;
                             } 
    ...
    if (
        (stripos($institution, "Galveston") !== false || stripos($institution, "Jennie Sealy") !== false) &&
        (stripos($description, "CT ") !== false || stripos($description, "CTA") !== false)
    ) {
        $acccustomer = 206;
    }

    else if (
        stripos($institution, "Angleton") !== false &&
        (stripos($description, "CT ") !== false || stripos($description, "CTA") !== false)
    ) {
        $acccustomer = 203;
    }
        ...
        stripos($institution, "Angleton") !== false &&
        stripos($description, "MR ") !== false
    ) {
        $acccustomer = 204;
    }

    else if (
        (stripos($institution, "CLC") !== false || stripos($institution, "Clear Lake") !== false || stripos($institution, "Victory Lakes") !== false) &&
        (stripos($description, "CT ") !== false || stripos($description, "CTA") !== false)
    ) {
        $acccustomer = 205;
    }
        ...
        (stripos($institution, "LCC") !== false || stripos($institution, "League City") !== false) &&
        (stripos($description, "CT ") !== false || stripos($description, "CTA") !== false)
    ) {
        $acccustomer = 208;
    }
