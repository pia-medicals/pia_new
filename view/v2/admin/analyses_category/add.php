                        ...
                        <form id="myForm" name="myForm" role="Form" method="post" class="admin_form" accept-charset="UTF-8" autocomplete="off">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="category" class="form-control" required="" name="category" placeholder="Enter Analysis Category Name" maxlength="100">
                                </div>
                            </div>
                            <!-- /.card-body -->
...
<script>
 ...
 $("#myForm").validate({
    ...
    submitHandler: function () {
        save_analyses_category();
    }
});

function save_analyses_category() {
    $("#submit").prop("disabled", true).html('Please wait... <i class="fa fa-spinner fa-spin"></i>');
    $.ajax({
        type: "POST",
        data: {
        ...
        url: "/ajaxV2/save_analyses_category",
        dataType: "json",
        timeout: 60000,
