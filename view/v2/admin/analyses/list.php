                ...
                <div class="col-12">
                    ...
                    <div class="card data-tb-style">
                        <div class="card-header">
                            ...
                            <form method="post" action="/tat/export_analyses_info_excel" id="exportForm">
                                ...
                                <a href="<?= SITE_URL ?>/admin/analyses_add" class="btn btn-primary float-right" style="margin-right: 2px;"><i aria-hidden="true" class="fas fa-plus"></i> Add </a>
                            </form>
                            <?php /* <h3 class="card-title">List</h3>
                             <a href="<?= SITE_URL ?>/ajaxV2/get_excel_analyses" name="export" id="export" class="btn btn-success float-right"><i aria-hidden="true" class="fas fa-file-excel"></i> Download Excel</a>
                            <a href="<?= SITE_URL ?>/admin/analyses_add" class="btn btn-primary float-right" style="margin-right: 2px;"><i aria-hidden="true" class="fas fa-user"></i> Add </a>  */ ?>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
    ...
    $(document).ready(function() {
        var dataTable = $('#analyses_table').DataTable({
            ...
            "columnDefs": [{
                ...
                //                {responsivePriority: 2, targets: [-4, -1, -3, -2]}
            ],
            "autoWidth": false,
            "lengthMenu": [
                [10, 25, 50, 100, -1],
            ...
            "ajax": {
                url: "/ajaxV2/get_analyses_info",
                type: "post"
            }
        });

        $('#analyses_table').on('click', '.change_status', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/ajaxV2/ajaxChangeAnalysisStatus',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            id: id,
        ...
        $('#analyses_table').on('click', '.delete_link', function(e) {
            e.preventDefault();
