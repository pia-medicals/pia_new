                    ...
                    <div class="card card-primary">
                        ...
                        <form id="myForm" name="myForm" role="Form" method="post" class="admin_form" accept-charset="UTF-8" autocomplete="off">
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center">
                                ...
                                <?php /* <a href="<?= isset($page_id) ? SITE_URL . '/analyses_rates?edit=' . $page_id : SITE_URL . '/admin/analyses' ?>" class="btn btn-secondary float-right">
                                    Back
                                </a> */ ?>
                                <a href="<?= SITE_URL . '/admin/analyses' ?>" class="btn btn-secondary float-right">
                                    Back
                                </a>
