      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h2 class="box-title">Current Month</h2>
          </div>
...
<div class="dataTables_wrapper" > 
   ...
   <span> 
     <form method="post" action="/ajax/downloaddata_monthlyfilternewcsv">
...
$(document).ready(function(){ 
    ...
    function load_data(is_assignee)
    {
      ...
      // "lengthMenu": [[50], [50]],
       ...
       "serverSide":true,
       "ajax":{
        url:"/ajax/get_all_worksheet_current_month_info",
        type:"POST",
    ...
    function load_second_data(is_second)
    {
        var dataTable = $('#all_worksheet').DataTable({
          ...
          "serverSide":true,
          "ajax":{
            url:"/ajax/get_analyst_current_month_info",
            type:"POST",
