...
if(empty($edit_wsheet) ){
    $edit_wsheet['other'] = "";
    $edit_wsheet['status'] = "";
    $edit_wsheet['analyses_performed'] = "";
    $edit_wsheet['custom_analysis_description'] = "";
    $edit_wsheet['other_notes'] = "";
    $edit_wsheet['analyst_hours'] = "";
    $edit_wsheet['image_specialist_hours'] = "";
    $edit_wsheet['medical_director_hours'] = "";
}
