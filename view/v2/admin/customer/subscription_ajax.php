...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" id="count1" name="count1" class="form-control num" required="" min="1" max="9999999999">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            ...
            <table class="admin">
                    ...
                    if (!empty($subscriptions)) {
                        foreach ($subscriptions as $key => $value) {
                            ...
                            <tr>             
                                ...
                                <td> 
                                    <input disabled="" type="text" id="sub_count<?= $key ?>" class="form-control make-subs-editable num"  value="<?= $value['subscription_volume'] ?>" name="sub_count[]" required="" min="0" max="9999999999">
                                </td>
                                <td>
                ...
                <tfoot id="subscription-tfoot" <?php echo !empty($subscriptions) ? '' : 'style="display: none;"'; ?>>
                    <tr>
                        ...
                        <td colspan="1" style="width: 400px;"><input type="text" id="subscription_total" class="form-control make-subs-editable num" name="subscription_total" value="<?= $subscription_total ?>" required="" min="0" max="9999999999" disabled=""></td>
                    </tr>
                </tfoot>
            </table>
        </div>
