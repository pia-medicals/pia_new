                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-auto ml-auto">
                                        <div class="form-group mb-0">
                                            ...
                                            <?php /* <a href="<?= SITE_URL ?>/admin/analyses_add?page_id=<?= $id; ?>" class="btn btn-primary float-right" style="margin-right: 2px;"><i aria-hidden="true" class="fas fa-plus"></i> Add Analysis</a> */ ?>
                                            <a href="<?= SITE_URL ?>/admin/analyses" class="btn btn-primary float-right" style="margin-right: 2px;"><i aria-hidden="true" class="fas fa-plus"></i> Add Analysis</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="admin_table mb-5">
                                        <table id="analyses_rates_table" class="admin admtbl table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Item No.</th>
                                                    <th class="w-25">Analysis Name</th>
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= SITE_URL . '/admin/customer' ?>" class="btn btn-secondary">Back</a>
                        </div>
