...
<script>
    $(document).ready(function() {
        <?php /* var dataTable = $('#dataTbl').DataTable({
            "order": [
                [0, "desc"]
            ],
            "processing": true,
        ...
        var dataTable = $('#dataTbl').DataTable({
            ...
            "order": [], // Prevent default client-side ordering
            "ajax": {
                url: "/tat/get_turnaround_time_info",
                type: "post"
            },
            "columnDefs": [{
                    // targets: [1, 2], // Disable sorting on status and action buttons
                    targets: [2], // Disable sorting on status and action buttons
                    orderable: false
                },
                {
                    responsivePriority: 1,
