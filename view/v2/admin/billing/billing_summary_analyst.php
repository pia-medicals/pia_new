                        ...
                        <form method="post" class="admin_form" accept-charset="UTF-8" autocomplete="off" id="frmBilling">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Choose Analyst(s)</label>
                                            <select name="analysts[]" id="analysts" class="form-control" multiple="">
                                                <?php
                                                foreach ($analysts as $key => $value) {
                                                    if (isset($_POST['analysts'])) {
                                                        $an = $_POST['analysts'];
                                                    } else {
                                                        $an = '';
                                                    }
...
<script>
    ...
    $("#frmBilling").validate({
        submitHandler: function (form) {
            ...
            $.ajax({
                url: '/ajaxV2/billing_summary_analyst_ajax', // Update with the actual path to your PHP script
                type: 'POST',
                data: formData,
    ...
    $("#btn_clear").on("click", function () {
        $("#start_date").val('');
        $("#end_date").val('');
        $('#analysts').multiselect('deselectAll', false); // Deselect all options
        $('#analysts').multiselect('updateButtonText');  // Update button text
        $('.my-det-val').html('');
        $("#s_btn1").hide();
    });
