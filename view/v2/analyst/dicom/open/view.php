                ...
                <?php else: ?>
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr><td>Exam Time</td><td><?= htmlspecialchars($edit['#'] ?? '') ?></td></tr>
                            <tr><td>Status</td><td><?= htmlspecialchars($edit['status_name'] ?? '') ?></td></tr>
                            ...
                            <tr><td>Description</td><td><?= htmlspecialchars($edit['comment'] ?? '') ?></td></tr>
                        </tbody>
                    </table>
