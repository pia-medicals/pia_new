        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <a href="<?= SITE_URL . '/customer_dashboard' ?>" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <!-- <a href="<?= SITE_URL . '/' . $cntrlr . '/profile' ?>" class="nav-link">Profile</a> -->
                    <a href="<?= SITE_URL . '/customer_profile' ?>" class="nav-link">Profile</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="<?php echo SITE_URL . '/customer_logout'; ?>">
                        LOGOUT
                        <i class="fas fa-sign-out-alt"></i>
                    </a>
                </li>
