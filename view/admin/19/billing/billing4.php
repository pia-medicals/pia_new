      ...
      <div class="col-md-12 form_time">
        <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="admin_form inline-block">
          <div class="">
            ...
            echo (isset($_POST['start_date'])) ? $_POST['start_date'] : date('Y-m'); ?>">
            <?php
            ...
            <select name="site" id="site" class="" >
              ...
              if (!isset($_POST['site'])) echo "selected"; ?>>All</option>
             ...
             <?php foreach ($wsheet as $key => $wsheets) { 
                 ...
                 <?php //foreach ($work_detials as $key => $work_det) { ?>
                  <tr>
                    ...
                    <?php  $cost	=	'';foreach ($work_detials as $key => $work_det) {
						  $cost=$work_det['rate']+$cost; } if(!empty($cost)){echo '$ '.number_format($cost,2);}?>
                    </td>
                  </tr>
                  <?php } ?>
            <?php //} ?>          
