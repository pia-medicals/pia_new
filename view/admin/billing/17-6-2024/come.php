...
<div class="admin_table" id="billing_table">  
...
<h3>Subscription Package-<?php echo $custmernames[$kk]['name']; ?></h3>
  <thead>
    <tr><!-- 
      <th>S.No.</th> -->
      <th>Item</th>
...
<br />
          ...
          <table class="admin">
              <h3>Additional Billing Items -<?php echo $custmernames[$kk]['name']; ?></h3>
          <thead>
            <tr>
