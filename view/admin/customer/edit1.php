    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h2 class="box-title"><?= ucfirst($edit['name']) ?></h2>
            </div>
            <?php
            ...
            <div class="row">
               ...
               <div class="col-md-2">
                  <div class="form-group">
                     ...
                     <input type="text" id="custom_description" class="form-control">                                         
                  </div>
               </div>
               <div class="col-md-2">
                  <div class="form-group">
                ...
                <div class="col-md-2" style="display: none;">
                    <div class="form-group">
                        ...
                        <input type="number" id="min_time" class="form-control" data-rule-maxlength="5" >
                    </div>
                </div>
...
//                        }
                        ...
                        var markup =`
                           <tr>
							   ...
							   <td> 
                                 <input type="text" id="custom_description${x}" class="form-control" value="${custom_description}"  name="custom_description[]">
                               </td>
                               <td> 
                                 <input type="number" id="rate${x}" class="form-control" value="${rate}"  name="rate[]" data-rule-required="true" aria-required="true">
                               </td>
                               <td>
                                 <input value="${code}" type="number" id="code${x}" class="form-control"  name="code[]" aria-required="true" data-rule-required="true" data-rule-maxlength="4" >
                              </td>
                              <td style="display:none;"> 
                                 <input type="number" id="min_time${x}" class="form-control" value="${min_time}"  name="min_time[]" aria-required="true" data-rule-required="true" data-rule-maxlength="5">
                               </td>
                               <td>
            ...
            <table class="admin">
               ...
               <tbody id="analysis-tbody">
                  ...
                  <tr>
                      ...
                      <td> 
                        <input type="text" disabled id="custom_description_<?= $key ?>" class="make-editable form-control" value="<?=$value['custom_description'] ?>"  name="custom_description[]" >
                      </td>
                      <td> 
                      ...
                      <td style="display:none;"> 
                          <input type="number" disabled id="min_time<?= $key ?>" class="make-editable form-control" value="<?=$value['min_time'] ?>"  name="min_time[]" data-rule-required="true" aria-required="true" >
                      </td>
                      <td>
         ...
         <div class="col-md-5 float-left total_save_div">
            ...
            if($alert_data['msg'] == 'Subscription analysis created successfully'){
               ...
               <div class="input-group">
                  <input type="hidden" name="cid" id="cid" value="<?=$edit['id'] ?>">
