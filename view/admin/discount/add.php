...
?>
	...
	<div class="form-group">
		...
		<input type="number" id="minimum_value" class="form-control" required name="minimum_value"   min="<?= $max_disc ?>">
	</div>
	<div class="form-group">
		<label for="code">Maximum Value</label>
		<input type="number" id="maximum_value" class="form-control" required name="maximum_value" min="<?= $max_disc+1; ?>" value="">
	</div>
	<div class="form-group">
		<label for="price">Percentage</label>
		<input type="number" id="percentage" class="form-control" required name="percentage" value="$">
	</div>
	<div class="form-group ">
