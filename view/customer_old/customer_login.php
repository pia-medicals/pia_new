...
<head>
    ...
    <title>PIA Medical - Client Login</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form id="customerLoginForm" method="post" accept-charset="utf-8">
                    <div class="row mb-3">
                    ...
                    <div class="row">
                        <!-- /.col -->
                        <div class="col-12">
                            <button type="submit" id="custLogBtn" name="submit" class="btn btn-primary btn-block">Sign In</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
    ...
    <script src="<?php echo SITE_URL; ?>/assets/js/customer.validate.js"></script>
