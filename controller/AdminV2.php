...
class AdminV2 extends Controller {
    ...
    public function index() {
        ...
        $this->view('v2/dashboard/index', $data);
    }
    ...
    public function mydashboard() {
        ...
        $this->admin_sidebar_v2($data);
        $this->view('v2/dashboard/home', $data);
    }
    ...
    public function profile() {
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            if (!empty($this->empty_key_value($form_data))) {
                ...
                $this->redirect('mydashboard/profile');
            } else {
        ...
        $this->view('v2/user/profile', $data);
    }
    ...
    public function user() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!empty($this->empty_key_value($form_data))) {
                ...
                $this->add_alert('danger', 'Validation Error in ' . $error_label);
                $this->redirect('adminV2/user?edit=' . $form_data['id']);
            } else {
                $status = $this->Admindb->user_update($form_data);
                $this->add_alert($status['type'], $status['msg']);
                $this->redirect('adminV2/user?edit=' . $form_data['id']);
    ...
    public function add_user() {
        ...
        if (isset($_POST['submit'])) {
            ...
            $this->redirect('adminV2/add_user');
        }
    ...
    public function dicom_details() {
        ...
        if (isset($_GET['delete']) && $_GET['delete'] != "") {
            ...
            $this->add_alert($status['type'], $status['msg']);
            $this->redirect('adminV2/dicom_details');
        }
        ...
        if (isset($_GET['edit']) && $_GET['edit'] != "") {
            ...
            $this->view('v2/admin/dicom/list', $data);
        }
    }
