    ...
    <div class="col-md-6"> 
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title text-capitalize">Daily Case Count</h3>
            ...
            <div class="box-body">
                <div class="chart">
                    <canvas id="casecount" style="height: 230px; width: 487px;" width="300" height="155"></canvas>
                    <script type="text/javascript">
<?php
$day = array_column($Week_case_count, 'day');
$count = array_column($Week_case_count, 'count');
...
<?php if ($result_from && $result_to) { ?>
                                var todayup = new Date("<?php echo $result_to ?>");
                                var ddup = todayup.getDate();
                                var mmup = todayup.getMonth() + 1;
                                var yyyyup = todayup.getFullYear();
                                if (ddup < 10)
                                {
                                    ddup = '0' + ddup;
                                }
                                ...
                                todayup = yyyyup + '-' + mmup + '-' + ddup;
                                var fromup = new Date("<?php echo $result_from ?>");
                                var fddup = fromup.getDate();
                                var fmmup = fromup.getMonth() + 1;
                                var fyyyyup = fromup.getFullYear();
                                if (fddup < 10)
                                {
                                    fddup = '0' + fddup;
                                }
...
<?php } ?>
                            ...
                            var data = [{
                                    ...
                                    backgroundColor: ['#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a', '#00a65a'],
                                    borderColor: ['#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59', '#48ba59'],
                                    fill: false,
                                    borderWidth: 1
                                },
                            ];
                            chartthediv('casecount', labels, data, type, yaxis, xaxis);
                        });
