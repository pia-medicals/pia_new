...
//            }
            ...
            if ($s_status == '') {
                ...
                $actData = '<a href="' . SITE_URL . '/dashboard/my_work_sheets?edit=' . $studies_id . '" class="btn btn-primary btn-xs">Edit</a><a  class="btn btn-warning btn-xs" style="display:none;" onclick="getreview(' . $studies_id . ')";>Review</a>';
            } else {
                $actData = '<a href="' . SITE_URL . '/dashboard/my_work_sheets?edit=' . $studies_id . '" class="btn btn-primary btn-xs">Edit</a><a  class="btn btn-warning btn-xs" style="display:none;" onclick="getreview(' . $studies_id . ')";>Review</a>';
            }
