...
class Router extends App
{
    ...
    public function routes()
    {
        ...
        $this->router->respond('GET|POST', '/analyst_add_new_study', function () {
            $this->controller('Analyst', 'add_new_study');
        });

        $this->router->respond(array('GET', 'POST'), '/analyst/ajax_get_open_studies', function () {
            $this->controller('Analyst', 'ajax_get_open_studies');
        });
