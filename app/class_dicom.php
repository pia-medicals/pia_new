...
//print_r($xml);
    ...
    $this->file = $this->jpg_file . date('YmdGis') . '.dcm';
    //$xml2dcm_cmd = BIN_XML2DCM . " $temp_xml " . $this->file;
    $xml2dcm_cmd = "xml2dcm" . " $temp_xml " . $this->file;
    ...
    $combine_cmd = "img2dcm" . " -df " . $this->file . " -stf " . $this->file . " -sef " . $this->file . " \"" . $this->jpg_file . "\" " . $this->file;
